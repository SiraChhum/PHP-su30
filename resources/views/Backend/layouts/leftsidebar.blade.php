  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Chhum Sira (SU30)</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item @yield('e_menu-open')">
            <a href="#" class="nav-link @yield('e_active')">
          ...
          <li class="nav-item @yield('dept_menu-open')">
            <a href="#" class="nav-link @yield('dept_active')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/department')}}" class="nav-link @yield('dept_active')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Department List</p>
                </a>
              </li>
            ...
            <li class="nav-item @yield('posi_menu-open')">
            <a href="#" class="nav-link @yield('posi_active')">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                Positon MGM
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/position')}}" class="nav-link @yield('posi_active')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Position List</p>
                </a>
              </li>
